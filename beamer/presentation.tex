...
\centering
\url{https://ai-learning-coach-lab.vercel.app/}
\end{exampleblock}
\end{columns}
\end{frame}
...
\begin{frame}{Dynamic Confidence Scoring System}
\begin{block}{Innovation Highlight}
Explainable Path implements a \textbf{dynamic confidence scoring system}
\end{block}
...
\begin{columns}
\column{0.5\textwidth}
\textbf{Three Confidence Metrics:}
\small
\begin{itemize}
    \item \textcolor{blue!80}{\textbf{Content Match (75-98\%)}}
    \begin{itemize}
        \item Topic relevance + exercises
    \end{itemize}
    
    \item \textcolor{green!70!black}{\textbf{Difficulty Fit (70-95\%)}}
    \begin{itemize}
        \item Easy: 80-95\%
        \item Medium: 75-90\%
        \item Hard: 70-85\%
    ...
    \item \textcolor{orange!80}{\textbf{Time Suitability (70-95\%)}}
    \begin{itemize}
        \item Short ($\leq$20 min): 85-95\%
        \item Medium (21-35 min): 78-90\%
        \item Long ($>$35 min): 70-85\%
    \end{itemize}
\end{itemize}
...
\small
\begin{itemize}
    \item \faCheckCircle{} \textbf{Realistic:} Reflects AI uncertainty
    \item \faCheckCircle{} \textbf{Dynamic:} Changes per recommendation
    \item \faCheckCircle{} \textbf{Transparent:} Shows feature impact
    \item \faCheckCircle{} \textbf{Educational:} Explains AI reasoning
\end{itemize}

\vspace{0.15cm}

\begin{exampleblock}{User Experience}
\small
Click "Try Another" $\rightarrow$ scores recalculate $\rightarrow$ bars animate
\end{exampleblock}
\end{columns}
\end{frame}
...
\begin{enumerate}
    ...
    \begin{itemize}
        ...
        \item \textcolor{blue!80}{\textbf{Observe dynamic confidence scores}}
        \item Click "Try Another" to see scores change
